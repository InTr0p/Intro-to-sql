...
SELECT * FROM users WHERE  name='Katherine'; /*llamada exactamente el nombre*/

SELECT * FROM users WHERE name like 'Katherine'; /*llamada especifica sin tomar encuenta may, min*/
